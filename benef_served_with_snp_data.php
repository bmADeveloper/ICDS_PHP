...
?>
<br><br><br><br>
  <h2><p align="center">::<u>Total No.of Beneficiaries served with SNP out of the total SNP Beneficiaries particular date or month</u>::</p></h1>

<?php
	
	
		$query="SELECT centre_detailss.centre_name,assignment_data.total_snp_benefeceries,assignment_data.benefeceries_served_with_snp FROM assignment_data INNER JOIN centre_detailss ON centre_detailss.centre_code=assignment_data.centre_code WHERE date(assignment_data.assignment_date_time) BETWEEN '$from' AND '$to' AND assignment_data.sup_code='$sup_code'";
