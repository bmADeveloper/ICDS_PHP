...
*/
 ...
 //$block_name=$_SESSION['BlockName'];
    $block_code=trim($_POST['block_codegpward']);       
   $from=trim($_POST['from_date']); 
   $to=trim($_POST['to_date']);
   $project_code=trim($_POST['proj_code']);
   $gp_ward_code=trim($_POST["gpward_code"]); 
   $visit_unvisit=trim($_POST['visit_unvisit']);
   
 //$gp_ward_code=trim($gp);
 //$project_code=trim($p_code);
 //echo "trim".$gp_ward_code;
// echo $project_code;
 ...
 //...............................................Block Name...............................
	...
	//.......................................GP / Ward name...........................................................			 
	           $result3 = mysql_query("select gp_ward_name from gp_ward_details where gp_ward_code='$gp_ward_code' ");   
    ...
    <table align="left">
       <tr>
		   <td><?php echo "Report From: <b>".$from ."</b>   To: <b>".$to."</b>"?></td>
            ...
            <td>&nbsp;&nbsp;&nbsp;</td>
            <td>&nbsp;&nbsp;&nbsp;</td>
            <td>GP/Ward Name : <strong><?php echo $gpward_name;?></strong></td>
...
<table align="center" border="1">
		...
		$a=0;
		$count=0;
		 $result2=mysql_query("select centre_code from centre_detailss where gp_ward_code='$gp' and project_code=$project_code");
		 while($row4=mysql_fetch_array($result2,MYSQL_NUM))
		 {
			//echo $row4[0];
			$c++;
			while($c>0)
			{
				$result4=mysql_query("SELECT centre_code,centre_name,centre_address,centre_latitude,centre_longitude,sector_name 
												 FROM centre_detailss    
                                                   INNER JOIN sector_details
												      ON centre_detailss.sector_code=sector_details.sector_code                                                           
													WHERE centre_code=$row4[0]");
				while($row5=mysql_fetch_array($result4,MYSQL_NUM))
				{
				  //echo $row5[1];
				  $d++;
				  while($d>0)
				  {
					  $result5=mysql_query("select * from assignment_data where date(assignment_date_time) >='$from' and date(assignment_date_time) <='$to' and  centre_code='$row5[0]'");
					  while($row6=mysql_fetch_array($result5,MYSQL_NUM))
					  {
						  //$distance=get_meters_between_points($row5[3],$row5[4],$row6[6],$row6[7]). " Meters<br>";
						  $distance=number_format (get_meters_between_points($row5[3],$row5[4],$row6[6],$row6[7]),3,'.',''). " Meters<br>";
						//echo $row6[1];
						$a++;
						while($a>0)
						{
							  $result6=mysql_query("select * from supervisor where sup_code='$row6[3]'");
							  while($row7=mysql_fetch_array($result6,MYSQL_NUM))  //supervisor details table
							  {
								//  echo $row7[2];
								  $serialno++;
								  ?>
                                     <tr>
                                           ...
                                           <td><?php echo $row5[3]." / ".$row5[4];?></td>
                                          
                                           <td><?php echo $row6[6]." / ".$row6[7];?></td> 
...
<table align="center" border="1">
		...
		$a=0;
		$count=0;
		 $result2=mysql_query("select centre_code from centre_detailss where gp_ward_code='$gp_ward_code' and project_code=$project_code");
		 while($row4=mysql_fetch_array($result2,MYSQL_NUM))
		 {
			//echo $row4[0];
			$c++;
				...
				while($row5=mysql_fetch_array($result4,MYSQL_NUM))
				{
				  ...
				  while($d>0)
				  {
					  ...
					  while($row6=mysql_fetch_array($result5,MYSQL_NUM))
					  {
						...
						while($a>0)
						{
							  $reqult6=mysql_query("select * from supervisor where sup_code='$row6[3]'");
							  while($row7=mysql_fetch_array($reqult6,MYSQL_NUM))  //supervisor details table
							  {
								//  echo $row7[2];
								 
							  ?>
                                <tr>  
                                       <td align="center"><img src="VisitedImage/<?php echo $row6[9];?>" height="50" width="120"/></td>
                                       <td align="center"><?php echo $row6[10];?></td>
                                       <td align="center"><?php echo $row6[11];?></td>
                                       <td align="center"><?php echo $row6[12];?></td>
                                       <td align="center"><?php echo $row6[13];?></td>
                                       <td align="center"><?php echo $row6[14];?></td> 
                                       <td align="center"><?php echo $row6[15];?></td>
                                       <td align="center"><?php echo $row6[16];?></td>
                                       <td align="center"><?php echo $row6[17];?></td>
                                       <td align="center"><?php echo $row6[18];?></td>
                                       <td align="center"><?php echo $row6[19];?></td>
					  ...
					  while($row6=mysql_fetch_array($result5,MYSQL_NUM))
					  {
						...
						while($a>0)
						{
							  ...
							  while($row7=mysql_fetch_array($reqult6,MYSQL_NUM))  //supervisor details table
							  {
							   ...
							   ?>
                                 <tr>  
                                       <td align="center"><?php echo $row6[20];?></td>
                                       <td align="center"><?php echo $row6[21];?></td>
                                       <td align="center"><?php echo $row6[22];?></td> 
                                       <td align="center"><?php echo $row6[23];?></td>
                                       <td align="center"><?php echo $row6[24];?></td>
                                       
                                       <td align="center"><?php echo $row7[2]?></td>
                                       <td align="center"><?php echo $row7[5]?></td>
                                       <td align="center"><?php echo $row7[6]?></td>
                                      <td align="center"><img src="nic_icds_app/<?php echo $row7[8];?>" height="50" width="50"/></td>
                                 </tr>
                            <?php
    ...
    <table align="left">
       <tr>
           ...
           <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <td>&nbsp;&nbsp;&nbsp;</td>
            <td>&nbsp;&nbsp;&nbsp;</td>
            <td>GP/Ward Name :<?php echo $gpward_name;?></td>
...
<br />
	<table align="center" border="1">
        ...
        <tr> 
         ...
         $result11=mysql_query("select centre_code from centre_detailss where gp_ward_code='$gp_ward_code' and project_code=$project_code");
		 while($row=mysql_fetch_array($result11,MYSQL_NUM))
		 {
			...
			while($c>0)
			{
			  $result_cdetails=mysql_query("SELECT centre_code,centre_name,centre_address,centre_latitude,centre_longitude,sector_name,sup_code  
												 FROM centre_detailss    
                                                   INNER JOIN sector_details
												      ON centre_detailss.sector_code=sector_details.sector_code                                                           
													WHERE centre_code=$row[0]");
			  while($row2=mysql_fetch_array($result_cdetails,MYSQL_NUM))
			  {
