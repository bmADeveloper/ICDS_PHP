...
<html>
  <head>
    <title>Total No.of child weighted (below 5years)</title>
  </head>
 <body>
      <h2><p align="center">Total No.of child weighted (below 5years)</p> </h2>
	   <form name="fm"  action="child_weight_data.php" method="post" onSubmit="valid_empty();">
		 <br> 
		 <table align="center">
				  <tr><td></td></tr>
				<tr><td></td></tr>
