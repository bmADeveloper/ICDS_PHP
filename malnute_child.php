...
<html>
  <head>
    <title>Total No.of child Malnourised (below 5years)</title>
  </head>
 <body>
      <h2><p align="center">Total No.of child Malnourised (below 5years)</p> </h2>
	   <form name="fm"  action="malnute_child_data.php" method="post" onSubmit="valid_empty();">
		 <br> 
		 <table align="center">
				  <tr><td></td></tr>
				<tr><td></td></tr>
