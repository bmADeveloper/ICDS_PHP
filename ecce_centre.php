...
<html>
  <head>
    <title>Total No.of AWCs following ECCE Curiculum out of the total visit made by visitor/CDPO/DPO/Supervisor</title>
  </head>
 <body>
      <h3><p align="center">Total No.of AWCs following ECCE Curiculum out of the total visit made by visitor/CDPO/DPO/Supervisor</p> </h3>
	   <form name="fm"  action="ecce_centre_data.php" method="post" onSubmit="valid_empty();">
		 <br> 
		 <table align="center">
				  <tr><td></td></tr>
				<tr><td></td></tr>
