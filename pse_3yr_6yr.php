...
<html>
  <head>
    <title>Total No.of PSE out of total child (3yr-6yr)particular  date or month</title>
  </head>
 <body>
      <h2><p align="center">Total No.of PSE out of total child (3yr-6yr)particular  date or month</p> </h2>
	   <form name="fm"  action="pse_3yr_6yr_data.php" method="post" onSubmit="valid_empty();">
		 <br> 
		 <table align="center">
				  <tr><td></td></tr>
				<tr><td></td></tr>
