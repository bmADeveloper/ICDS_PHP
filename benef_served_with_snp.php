...
<html>
  <head>
    <title>Total No.of Beneficiaries served with SNP out of the total SNP Beneficiaries by particular date or month</title>
  </head>
 <body>
      <h2><p align="center">Total No.of Beneficiaries served with SNP out of the total SNP Beneficiaries particular date or month</p> </h2>
	   <form name="fm"  action="benef_served_with_snp_data.php" method="post" onSubmit="valid_empty();">
		 <br> 
		 <table align="center">
				  <tr><td></td></tr>
				<tr><td></td></tr>
